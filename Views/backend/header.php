...
<head>
   ...
   <link rel="stylesheet"
      ...
      <link rel="stylesheet" href="textbackend.css">
...
<body class="ttd-transition sidebar-mini">
   <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
           <!-- Brand Logo -->
    <a href="http://localhost/HoangPhiTu_2122110029/admin/index.php" class="brand-link">
     ...
     <span class="brand-text font-weight-light text-center"><h3>Admin</h3></span>
         ...
         <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
               <div class="image">
               <img src="../public/images/user/<?=($_SESSION['avt.jpg'])??'avt.jpg'; ?>" 
                  class="img-circle elevation-2" alt="<?=($_SESSION['avt.jpg'])??'avt.jpg'; ?>">
